...
[![GoDoc](https://godoc.org/github.com/taraflex/goproxy?status.svg)](https://godoc.org/github.com/taraflex/goproxy)
[![Join the chat at https://gitter.im/taraflex/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/taraflex/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/taraflex/goproxy/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/taraflex/goproxy.v1`.
...
[the eavesdropper example](https://github.com/taraflex/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/taraflex/goproxy/tree/master/examples/goproxy-transparent)
